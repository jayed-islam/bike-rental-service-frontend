...
const PaymentView: React.FC<Props> = ({ id, startTime }) => {
  const {
    data: bike,
  ...
  return (
    <div className="bg-gray-100">
      <div className="max-w-5xl mx-auto px-5 xl:px-0 py-7">
        <FormProvider methods={methods} onSubmit={onSubmit}>
          <div className="flex items-start gap-7 lg:flex-row flex-col">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <Typography variant="body1" className="text-gray-700">
                    <span className="font-medium">Name:</span> {bike?.data.name}
                  </Typography>
                  <Typography variant="body1" className="text-gray-700">
